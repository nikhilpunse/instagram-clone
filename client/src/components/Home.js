              ...
              return(
                <div className="home_card" key={item._id}>
                  ...
                  <div style={{display:'flex'}}>
                    <i style={{color:'#d50000',marginLeft:'10px'}} className="material-icons">favorite</i>
                  ...
                  <h6 style={{marginLeft:'15px'}}>{item.likes.length} likes</h6>
                  <h6 style={{marginLeft:'15px'}}>{item.title}</h6>
                  <h6 style={{marginLeft:'15px'}}>{item.body}</h6>
